...
<head>
	<meta charset="utf-8">
  <!-- Se creó un puerto de vista con un contenido: ancho = ancho del dispositivo, escala inicial = 1 -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<title>Sistema de Veterinario</title>
  <!-- se utilizó un bootstrap para tener hoja de estilo con integridad y un origen cruzado anonimo-->
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">

  <style>
body {
  /* se agregó una imagen de fondo para la pagina, que el fondo sea reparado y que el fondo se cubra*/
...
<body>
 <!-- para el origen del script se utilizó un bootstrap y un popper con integridad y un origen cruzado anonimo -->
<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.10.2/dist/umd/popper.min.js" integrity="sha384-7+zCNj/IqJ95wo16oMtfsKbZ9ccEh31eOz1HGyDuCQ6wgnyJNSYdrPa03rtR1zdB" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.min.js" integrity="sha384-QJHtvGhmr9XOIpI6YVutG+2QOK9T+ZnN4kzFN1RtK3zEFEIsxhlmWl5/YESvpZ13" crossorigin="anonymous"></script>

<!-- la clase de navegación, la a class tenga Marca de barra de navegación, el boton alterne la barra de navegación, arial label=Navegación de palanca -->
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="InterfazUsuario.html">INTERFAZ ADMIN (Auxiliar de Clinica)</a>
