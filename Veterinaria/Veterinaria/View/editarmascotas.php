...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET idpropietario = '".$_POST['nombreForm']."',
                        nombre = '".$_POST['apellidoForm']."', tipo='".$_POST['hora']."'
      ...
      $query = "SELECT id, idpropietario, nombre,tipo FROM $tabla;";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, idpropietario, nombre,tipo FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         ID PROPIETARIO: <input type="text" name="nombreForm" value="<?=$rowSelectByID['idpropietario'];?>"> <br> <br>
         NOMBRE: <input type="text" name="apellidoForm" value="<?=$rowSelectByID['nombre'];?>"> <br> <br>
         TIPO: <input type="text" name="hora" value="<?=$rowSelectByID['tipo'];?>"> <br> <br>
