...
<?php
      ...
      if($_POST)
      {
         $queryInsert = "INSERT INTO $tabla (idmascota, lugar,dias) VALUES ('".$_POST['nombreForm']."', '".$_POST['apellidoForm']."','".$_POST['dias']."');";
      ...
      $query = "SELECT idmascota, lugar,dias FROM $tabla;";
      ...
      <form action="" method="post">
         ...
         Lugar : <input type="text" name="apellidoForm"> <br> <br>
          Dias de Estancia: <input type="text" name="dias"> <br> <br>
