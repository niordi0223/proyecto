...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <form action="../../Controller/InsertarPruebaController.php" method="POST">
  <br> <h1> REGISTRO PRUEBAS</h1><br>
    Prueba: <input type="text" name="txtmascota"><br>
