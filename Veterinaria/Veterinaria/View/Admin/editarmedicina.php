    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
            ...
            <li><a class="dropdown-item" href="editarmedicina.php">Editar Cita</a></li>
          </ul>
        </li>
      <li class="nav-item">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
            <li><a class="dropdown-item" href="solimascota.php">Registro</a></li>
...
<a class="nav-link" href="estancias.php"tabindex="-1" aria-expanded="true">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET nombre = '".$_POST['nombreForm']."',
                        descripcion = '".$_POST['apellidoForm']."'
      ...
      $query = "SELECT id, nombre, descripcion FROM $tabla;";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, nombre, descripcion FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         Descripcion: <input type="text" name="apellidoForm" value="<?=$rowSelectByID['descripcion'];?>"> <br> <br>
