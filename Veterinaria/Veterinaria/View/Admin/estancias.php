  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
     ...
     <li class="nav-item dropdown">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET estatus = '".$_POST['nombreForm']."'WHERE id = ".$_POST['idForm'].";";
      ...
      $query = "SELECT id, nombredelC, dia,hora,estatus FROM $tabla;";
      ...
      { 
         ...
         echo "</td>";
         echo "<td>";
         echo "<a href=\"?id=".$row["id"]."\">Aceptar/Rechazar</a>";
         echo "</td>";
         echo "</tr>";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, nombredelC, dia,hora,estatus FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         NombreCliente: <input type="text" name="nombreForm" value="<?=$rowSelectByID['estatus'];?>"> <br> <br>
