...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET prueba = '".$_POST['nombreForm']."',
      ...
      $query = "SELECT id, prueba, descripcion FROM $tabla;";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, prueba, descripcion FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         prueba: <input type="text" name="nombreForm" value="<?=$rowSelectByID['prueba'];?>"> <br> <br>
         descripcion: <input type="area" name="apellidoForm" value="<?=$rowSelectByID['descripcion'];?>"> <br> <br>
