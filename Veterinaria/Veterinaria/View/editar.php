...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET nombredelC = '".$_POST['nombreForm']."',
                        dia = '".$_POST['apellidoForm']."', hora='".$_POST['hora']."'
      ...
      $query = "SELECT id, nombredelC, dia,hora FROM $tabla;";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, nombredelC, dia,hora FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         NombreCliente: <input type="text" name="nombreForm" value="<?=$rowSelectByID['nombredelC'];?>"> <br> <br>
         dia: <input type="date" name="apellidoForm" value="<?=$rowSelectByID['dia'];?>"> <br> <br>
         hora: <input type="time" name="hora" value="<?=$rowSelectByID['hora'];?>"> <br> <br>
