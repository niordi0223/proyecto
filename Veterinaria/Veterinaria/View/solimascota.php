...
<?php
      ...
      if($_POST)
      {
         $queryInsert = "INSERT INTO $tabla (idpropietario, nombre,tipo) VALUES ('".$_POST['nombreForm']."', '".$_POST['apellidoForm']."','".$_POST['dias']."');";
      ...
      $query = "SELECT idpropietario, nombre,tipo FROM $tabla;";
      ...
      <form action="" method="post">
         ID PROPIETARIO: <input type="text" name="nombreForm"> <br> <br>
         NOMBRE : <input type="text" name="apellidoForm"> <br> <br>
          TIPO: <input type="text" name="dias"> <br> <br>
