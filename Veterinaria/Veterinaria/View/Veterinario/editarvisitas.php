...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET idanimal = '".$_POST['nombreForm']."',
                        dias='".$_POST['hora']."'
      ...
      $query = "SELECT id, idanimal,dias FROM $tabla;";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, idanimal,dias FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         ID MASCOTA: <input type="text" name="nombreForm" value="<?=$rowSelectByID['idanimal'];?>"> <br> <br>
