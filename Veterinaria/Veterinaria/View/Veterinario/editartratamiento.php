    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET idmascota = '".$_POST['nombreForm']."',
                        medicamento = '".$_POST['apellidoForm']."', tiempo='".$_POST['hora']."'
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, idmascota, medicamento,tiempo FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         lugar: <input type="text" name="apellidoForm" value="<?=$rowSelectByID['medicamento'];?>"> <br> <br>
         dias: <input type="text" name="hora" value="<?=$rowSelectByID['tiempo'];?>"> <br> <br>
