...
<?php
      ...
      if($_POST)
      {
         $queryInsert = "INSERT INTO $tabla (idmascota, medicamento,tiempo) VALUES ('".$_POST['nombreForm']."', '".$_POST['apellidoForm']."','".$_POST['dias']."');";
      ...
      $query = "SELECT idmascota, medicamento,tiempo FROM $tabla;";
      ...
      <form action="" method="post">
         ID MASCOTA: <input type="text" name="nombreForm"> <br> <br>
         medicamento : <input type="text" name="apellidoForm"> <br> <br>
         Tiempo: <input type="text" name="dias"> <br> <br>
