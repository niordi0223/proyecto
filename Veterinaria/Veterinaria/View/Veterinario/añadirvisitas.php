...
<?php
      ...
      if($_POST)
      {
         $queryInsert = "INSERT INTO $tabla (idanimal, dias) VALUES ('".$_POST['nombreForm']."', '".$_POST['apellidoForm']."');";
      ...
      $query = "SELECT idanimal,dias FROM $tabla;";
      ...
      <form action="" method="post">
         ...
         DIAS : <input type="text" name="apellidoForm"> <br> <br>
