...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      if($_POST)
      {
         $queryUpdate = "UPDATE $tabla SET idmascota = '".$_POST['nombreForm']."',
                        lugar = '".$_POST['apellidoForm']."', dias='".$_POST['hora']."'
      ...
      $query = "SELECT id, idmascota, lugar,dias FROM $tabla;";
      ...
      if($_GET)
      {
         $querySelectByID = "SELECT id, idmascota, lugar,dias FROM $tabla WHERE id = ".$_GET['id'].";";
      ...
      <form action="" method="post">
         ...
         ID MASCOTA: <input type="text" name="nombreForm" value="<?=$rowSelectByID['idmascota'];?>"> <br> <br>
         lugar: <input type="text" name="apellidoForm" value="<?=$rowSelectByID['lugar'];?>"> <br> <br>
         dias: <input type="text" name="hora" value="<?=$rowSelectByID['dias'];?>"> <br> <br>
